...
$(function () {
	...
	"contacts": "<div class='project-members'><a href='javascript:void(0)'><img src='../images/avatar/1.jpg' class='rounded b-0  w-30 h-30 offline' alt='user'></a> </div> ",
	"status": "<span class='badge badge-success'>Active</span>",	
	"tracker": "<button type='button' class='btn btn-sm btn-toggle btn-info active rounded' data-bs-toggle='button' aria-pressed='true'><span class='handle'></span></button>",
	"starts": "01-21-2023",
	"ends": "<strong>02-30-2024</strong>",
	...
	"contacts": "<div class='project-members'><a href='javascript:void(0)'><img src='../images/avatar/2.jpg' class='rounded b-0  w-30 h-30 online'></a> <a href='javascript:void(0)'><img src='../images/avatar/4.jpg' class='rounded b-0  w-30 h-30 busy'></a><a href='javascript:void(0)'><img src='../images/avatar/3.jpg' class='rounded b-0  w-30 h-30 away'></a> </div> ",
	"status": "<span class='badge badge-success'>Active</span>",
	"tracker": "<button type='button' class='btn btn-sm btn-toggle btn-info rounded' data-bs-toggle='button' aria-pressed='true'><span class='handle'></span></button>",
	"starts": "01-17-2023",
	"ends": "<strong>02-30-2024</strong>",
	"comments": "This is a blank comments area, used to add comments and keep notes",
	"action": "<button class='btn btn-xs'>Open case</button> <button class='btn btn-xs btn-danger pull-right' style='margin-left:5px'>Delete Record</button> <button class='btn btn-xs btn-success pull-right'>Save Changes</button> "
	...
	"contacts": "<div class='project-members'><a href='javascript:void(0)'><img src='../images/avatar/1.jpg' class='rounded b-0  w-30 h-30 online' alt='user'></a><a href='javascript:void(0)'><img src='../images/avatar/2.jpg' class='rounded b-0  w-30 h-30 online'></a> <a href='javascript:void(0)'><img src='../images/avatar/3.jpg' class='rounded b-0  w-30 h-30 busy'></a> </div> ",
	"status": "<span class='badge badge-success'>Active</span>",
	"tracker": "<button type='button' class='btn btn-sm btn-toggle btn-info active rounded' data-bs-toggle='button' aria-pressed='true'><span class='handle'></span></button>",
	"starts": "01-8-2023",
	"ends": "<strong>03-03-2024</strong>",
	"comments": "This is a blank comments area, used to add comments and keep notes",
	"action": "<button class='btn btn-xs'>Open case</button> <button class='btn btn-xs btn-danger pull-right' style='margin-left:5px'>Delete Record</button> <button class='btn btn-xs btn-success pull-right'>Save Changes</button> "
	},   
	{
	...
	"contacts": "<div class='project-members'><a href='javascript:void(0)'><img src='../images/avatar/5.jpg' class='rounded b-0  w-30 h-30 busy'></a> </div> ",
	"status": "<span class='badge badge-success'>Active</span>",
	"tracker": "<button type='button' class='btn btn-sm btn-toggle btn-info rounded' data-bs-toggle='button' aria-pressed='true'><span class='handle'></span></button>",
	"starts": "01-12-2023",
	"ends": "<strong>03-15-2024</strong>",
	"comments": "This is a blank comments area, used to add comments and keep notes",
	"action": "<button class='btn btn-xs'>Open case</button> <button class='btn btn-xs btn-danger pull-right' style='margin-left:5px'>Delete Record</button> <button class='btn btn-xs btn-success pull-right'>Save Changes</button> "
	},   
	{
	...
	"contacts": "<div class='project-members'><a href='javascript:void(0)'><img src='../images/avatar/6.jpg' class='rounded b-0  w-30 h-30 online'></a> <a href='javascript:void(0)'><img src='../images/avatar/3.jpg' class='rounded b-0  w-30 h-30 busy'></a></div> ",
	"status": "<span class='badge badge-success'>Active</span>",
	"tracker": "<button type='button' class='btn btn-sm btn-toggle btn-info rounded' data-bs-toggle='button' aria-pressed='true'><span class='handle'></span></button>",
	"starts": "01-13-2023",
	"ends": "<strong>06-20-2024</strong>",
	"comments": "This is a blank comments area, used to add comments and keep notes",
	"action": "<button class='btn btn-xs'>Open case</button> <button class='btn btn-xs btn-danger pull-right' style='margin-left:5px'>Delete Record</button> <button class='btn btn-xs btn-success pull-right'>Save Changes</button> "
	},   
	{
	...
	"contacts": "<div class='project-members'><a href='javascript:void(0)'><a href='javascript:void(0)'><img src='../images/avatar/1.jpg' class='rounded b-0  w-30 h-30 away'></a><a href='javascript:void(0)'><img src='../images/avatar/5.jpg' class='rounded b-0  w-30 h-30 away'></a> </div> ",
	"status": "<span class='badge badge-success'>Active</span>",
	"tracker": "<button type='button' class='btn btn-sm btn-toggle btn-info active rounded' data-bs-toggle='button' aria-pressed='true'><span class='handle'></span></button>",
	"starts": "01-9-2023",
	"ends": "<strong>08-01-2024</strong>",
	"comments": "This is a blank comments area, used to add comments and keep notes",
	"action": "<button class='btn btn-xs'>Open case</button> <button class='btn btn-xs btn-danger pull-right' style='margin-left:5px'>Delete Record</button> <button class='btn btn-xs btn-success pull-right'>Save Changes</button> "
	},   	
	{
	...
	"contacts": "<div class='project-members'><a href='javascript:void(0)'><img src='../images/avatar/4.jpg' class='rounded b-0  w-30 h-30 online' alt='user'></a></div> ",
	"status": "<span class='badge badge-default'>Inactive</span>",
	"tracker": "<button type='button' class='btn btn-sm btn-toggle btn-info rounded' data-bs-toggle='button' aria-pressed='true'><span class='handle'></span></button>",
	"starts": "01-4-2023",
	"ends": "<strong>09-11-2024</strong>",
	"comments": "This is a blank comments area, used to add comments and keep notes",
	"action": "<button class='btn btn-xs'>Open case</button> <button class='btn btn-xs btn-danger pull-right' style='margin-left:5px'>Delete Record</button> <button class='btn btn-xs btn-success pull-right'>Save Changes</button> "
	},   
	{
	...
	"contacts": "<div class='project-members'><a href='javascript:void(0)'><img src='../images/avatar/2.jpg' class='rounded b-0  w-30 h-30 offline'></a> </div> ",
	"status": "<span class='badge badge-success'>Active</span>",
	"tracker": "<button type='button' class='btn btn-sm btn-toggle btn-info rounded' data-bs-toggle='button' aria-pressed='true'><span class='handle'></span></button>",
	"starts": "01-11-2023",
	"ends": "<strong>07-11-2024<strong>",
	"comments": "This is a blank comments area, used to add comments and keep notes",
	"action": "<button class='btn btn-xs'>Open case</button> <button class='btn btn-xs btn-danger pull-right' style='margin-left:5px'>Delete Record</button> <button class='btn btn-xs btn-success pull-right'>Save Changes</button> "
	},   
	{
	...
	"contacts": "<div class='project-members'><a href='javascript:void(0)'><img src='../images/avatar/1.jpg' class='rounded b-0  w-30 h-30 offline'></a> <a href='javascript:void(0)'><img src='../images/avatar/2.jpg' class='rounded b-0  w-30 h-30 busy'></a><a href='javascript:void(0)'><img src='../images/avatar/3.jpg' class='rounded b-0  w-30 h-30 away'></a><a href='javascript:void(0)'></a> </div> ",
	"status": "<span class='badge badge-success'>Active</span>",
	"tracker": "<button type='button' class='btn btn-sm btn-toggle btn-info rounded' data-bs-toggle='button' aria-pressed='true'><span class='handle'></span></button>",
	"starts": "01-19-2023",
	"ends": "<strong>08-30-2024<strong>",
	"comments": "This is a blank comments area, used to add comments and keep notes",
	"action": "<button class='btn btn-xs'>Open case</button> <button class='btn btn-xs btn-danger pull-right' style='margin-left:5px'>Delete Record</button> <button class='btn btn-xs btn-success pull-right'>Save Changes</button> "
	},   
	{
	...
	"est": "<td><div class='progress progress-sm'><div class='progress-bar progress-bar-primary progress-bar-striped' role='progressbar' aria-valuenow='55' aria-valuemin='0' aria-valuemax='100' style='width: 55%'></div></div></td>",
	"contacts": "<div class='project-members'><a href='javascript:void(0)'><img src='../images/avatar/8.jpg' class='rounded b-0  w-30 h-30 online'></a></div> ",
	"status": "<span class='badge badge-success'>Active</span>",
	"tracker": "<button type='button' class='btn btn-sm btn-toggle btn-info rounded' data-bs-toggle='button' aria-pressed='true'><span class='handle'></span></button>",
	"starts": "01-20-2023",
	"ends": "<strong>02-30-2024</strong>",
	...
	"contacts": "<div class='project-members'><a href='javascript:void(0)'><img src='../images/avatar/7.jpg' class='rounded b-0  w-30 h-30 online'></a> <a href='javascript:void(0)'><img src='../images/avatar/3.jpg' class='rounded b-0  w-30 h-30 busy'></a><a href='javascript:void(0)'><img src='../images/avatar/2.jpg' class='rounded b-0  w-30 h-30 away'></a> </div> ",
	"status": "<span class='badge badge-success'>Active</span>",
	"tracker": "<button type='button' class='btn btn-sm btn-toggle btn-info rounded' data-bs-toggle='button' aria-pressed='true'><span class='handle'></span></button>",
	"starts": "01-25-2023",
	"ends": "<strong>03-03-2024</strong>",
	...
	"contacts": "<div class='project-members'><a href='javascript:void(0)'><img src='../images/avatar/7.jpg' class='rounded b-0  w-30 h-30 away' alt='user'></a><a href='javascript:void(0)'><img src='../images/avatar/5.jpg' class='rounded b-0  w-30 h-30 online'></a> </div> ",
	"status": "<span class='badge badge-success'>Active</span>",
	"tracker": "<button type='button' class='btn btn-sm btn-toggle btn-info rounded' data-bs-toggle='button' aria-pressed='true'><span class='handle'></span></button>",
	"starts": "01-29-2023",
	"ends": "<strong>12-15-2024</strong>",
	"comments": "This is a blank comments area, used to add comments and keep notes",
	"action": "<button class='btn btn-xs'>Open case</button> <button class='btn btn-xs btn-danger pull-right' style='margin-left:5px'>Delete Record</button> <button class='btn btn-xs btn-success pull-right'>Save Changes</button> "
	},   
	{
	...
	"contacts": "<div class='project-members'><a href='javascript:void(0)'><img src='../images/avatar/5.jpg' class='rounded b-0  w-30 h-30 online' alt='user'></a><a href='javascript:void(0)'><img src='../images/avatar/1.jpg' class='rounded b-0  w-30 h-30 online'></a> <a href='javascript:void(0)'><img src='../images/avatar/2.jpg' class='rounded b-0  w-30 h-30 busy'></a> </div> ",
	"status": "<span class='badge badge-success'>Active</span>",
	"tracker": "<button type='button' class='btn btn-sm btn-toggle btn-info rounded' data-bs-toggle='button' aria-pressed='true'><span class='handle'></span></button>",
	"starts": "01-8-2023",
	"ends": "<strong>07-07-2024</strong>",
	"comments": "This is a blank comments area, used to add comments and keep notes",
	"action": "<button class='btn btn-xs'>Open case</button> <button class='btn btn-xs btn-danger pull-right' style='margin-left:5px'>Delete Record</button> <button class='btn btn-xs btn-success pull-right'>Save Changes</button> "
	}     
    ]
