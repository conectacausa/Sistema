{{-- resources/views/beneficios/transporte/linhas/create.blade.php --}}
@extends('layouts.app')
  ...
  <div class="d-flex align-items-center">
    <div class="me-auto">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
          <a href="{{ route('beneficios.transporte.linhas.index', ['sub'=>$sub]) }}">Transporte</a>
        </li>
      ...
      <div class="box">
        <div class="box-body">
          ...
          <form method="POST" action="{{ route('beneficios.transporte.linhas.store', ['sub'=>$sub]) }}">
                ...
                <div class="form-group">
                  ...
                  <select name="motorista_id" class="form-select" required>
                    ...
                    @foreach($motoristas as $m)
                      <option value="{{ $m->id }}" {{ old('motorista_id')==$m->id?'selected':'' }}>
                        {{ $m->nome }}
                      </option>
                    @endforeach
                  </select>
            ...
            {{-- Botão salvar fora do conteúdo das abas (aqui não tem abas, mas mantém padrão no final) --}}
