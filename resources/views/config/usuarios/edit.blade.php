...
<head>
  ...
  <title>{{ config('app.name', 'ConecttaRH') }} | Editar Usuário</title>
        ...
        <div class="row">
          <div class="col-12">
            <div class="box">
              ...
              <div class="box-body">
                <form method="POST" action="{{ route('config.usuarios.update', $usuario->id) }}">
                  @csrf
                  @method('PUT')
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="nome_completo" class="form-control"
                               value="{{ old('nome_completo', $usuario->nome_completo) }}" required>
                      </div>
                    </div>
                      ...
                      <div class="form-group">
                        ...
                        <select name="permissao_id" class="form-select" required>
                          ...
                          @foreach($permissoes as $p)
                            <option value="{{ $p->id }}" {{ (string)old('permissao_id', $usuario->permissao_id)===(string)$p->id?'selected':'' }}>
                              {{ $p->nome_grupo }}
                            </option>
                          @endforeach
                        </select>
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input type="password" name="senha" class="form-control" placeholder="Preencha somente para alterar">
                      </div>
                    </div>
